// Get all the "More Details" buttons and their corresponding details
const knowMoreBtns = document.querySelectorAll('.knowmoreBtn');
const showDetailsLinks = document.querySelectorAll('.show_details');
const hideDetailsSections = document.querySelectorAll('.hide_details');

// Add a click event listener to each "More Details" button
knowMoreBtns.forEach((btn, index) => {
    btn.addEventListener('click', () => {
        // Toggle the visibility of the "More Details" button
        btn.style.display = 'none';

        // Hide the corresponding "Hide Details" section
        hideDetailsSections[index].style.display = 'none';

        // Show the "Show Details" section corresponding to the clicked button
        showDetailsLinks[index].style.display = 'block';
    });
});

// Add a click event listener to each "Show Details" link
showDetailsLinks.forEach((link, index) => {
    link.addEventListener('click', () => {
        // Hide the "Show Details" section
        link.style.display = 'none';

        // Show the corresponding "More Details" button
        knowMoreBtns[index].style.display = 'block';

        // Show the corresponding "Hide Details" section
        hideDetailsSections[index].style.display = 'block';
    });
});
